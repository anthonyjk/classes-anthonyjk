...
public class Environment
{
     ...
     * @param initH The height of the environment piece
     * @param initW The width of the environment piece
     */
    public Environment(int initX, int initY, double initH, double initW, Color initC)
    {
        this.x = initX;
        this.y = initY;
        this.height = initH;
    ...
    {
        Rectangle2D.Double env = new Rectangle2D.Double(this.x, this.y, this.width, this.height);
